...
hi StatusLine gui=none,bold guibg=#554741 guifg=#98b4ac cterm=none,bold ctermbg=0 ctermfg=14
hi StatusLineNC gui=none guibg=#554741 guifg=#5d6348 cterm=none ctermbg=0 ctermfg=10
hi VertSplit gui=none cterm=none
hi TabLine gui=none guibg=#554741 guifg=#837858 cterm=none ctermbg=0 ctermfg=11
...
hi Todo gui=none guibg=#554741 guifg=#aa8bee cterm=none ctermbg=0 ctermfg=13
...
hi CursorLine gui=none guibg=#554741 cterm=none ctermbg=0
hi CursorLineNr gui=none guibg=#554741 guifg=#78849c cterm=none ctermbg=0 ctermfg=12
hi ColorColumn guibg=#837858 ctermbg=11

hi Folded guibg=#554741 guifg=#f2f1ef ctermbg=0 ctermfg=15
hi FoldColumn guibg=#554741 guifg=#f2f1ef ctermbg=0 ctermfg=15
