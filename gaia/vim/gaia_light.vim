...
hi Visual guibg=#3d3e3f guifg=#94ae9f ctermbg=0 ctermfg=14
...
hi Warning gui=none guibg=#ad9f4d guifg=#2d2e2f cterm=none ctermbg=3 ctermfg=8
hi Error gui=none guibg=#a67336 guifg=#2d2e2f cterm=none ctermbg=1 ctermfg=8
...
" Diffs
" -----------------
hi DiffAdd guibg=#7c8e2d guifg=#2d2e2f ctermbg=2 ctermfg=8
hi DiffDelete gui=none guibg=#a67336 guifg=#2d2e2f ctermbg=1 cterm=none ctermfg=8
hi DiffChange guibg=#a9880b guifg=#2d2e2f ctermbg=9 ctermfg=8
