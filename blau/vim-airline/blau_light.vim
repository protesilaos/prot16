...
let g:airline#themes#blau_light#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
...
let g:airline#themes#blau_light#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#blau_light#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
...
let g:airline#themes#blau_light#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
...
let g:airline#themes#blau_light#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
...
let g:airline#themes#blau_light#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
