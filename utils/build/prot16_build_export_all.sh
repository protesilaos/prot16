...
# Builds and publishes all content files for each prot16 colour scheme
...
# IMPORTANT This script requires the prot16-builder nodejs package
...
# Update remote repos
# NOTE this does not update the main prot16 repo
# TODO atom theme repos
