...
let g:airline#themes#overgrowth_dark#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
...
let g:airline#themes#overgrowth_dark#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#overgrowth_dark#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
...
let g:airline#themes#overgrowth_dark#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
...
let g:airline#themes#overgrowth_dark#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
...
let g:airline#themes#overgrowth_dark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
