...
hi Visual guibg=#475944 guifg=#82a394 ctermbg=0 ctermfg=14
...
hi Error gui=none guibg=#b86a5c guifg=#374934 cterm=none ctermbg=1 ctermfg=8
...
" Diffs
" -----------------
hi DiffAdd guibg=#669252 guifg=#374934 ctermbg=2 ctermfg=8
hi DiffDelete gui=none guibg=#b86a5c guifg=#374934 ctermbg=1 cterm=none ctermfg=8
hi DiffChange guibg=#b37521 guifg=#374934 ctermbg=9 ctermfg=8
hi DiffText gui=none guibg=#bc7374 guifg=#374934 cterm=none ctermbg=5 ctermfg=8
